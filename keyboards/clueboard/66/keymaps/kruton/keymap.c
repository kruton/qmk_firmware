...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |---------------------------------------------------------------.
   * |Shf|Shft|  Z|  X|  M|  C|  V|  K|  L|  ,|  .|  /| Shft |Fn | UP|
   * |-------------------------------------------------------------------.
...
[_WM] = LAYOUT(
  ...
  KC_LSFT, KC_LSFT, KC_Z,   KC_X,   KC_M,   KC_C,   KC_V,   KC_K,   KC_L,   KC_COMM, KC_DOT,   KC_SLSH,  KC_RSFT, MO(_FN), KC_UP,
   ...
   * |---------------------------------------------------------------.
   * |Shf|Shft|  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /| Shft |Fn | UP|
   * |-------------------------------------------------------------------.
   * |Ctl |OS |Alt | MuHK| Space | Space | HK |Alt |Menu|Ctl |LFT|DWN|RIG|
   * `-------------------------------------------------------------------'
   */
[_JP] = LAYOUT(
  ...
  KC_LSFT, KC_LSFT, KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,   KC_N, KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(_FN), KC_UP,
  KC_LCTL, KC_LGUI, KC_LALT, KC_MHEN,         KC_SPC,         KC_SPC,        KC_HENK, KC_RALT, MO(_FN), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
),
